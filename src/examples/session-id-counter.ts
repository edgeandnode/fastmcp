...
const sessionData = new Map<string, { createdAt: Date; lastAccessed: Date; requestCount: number }>()
...
server.addTool({
  description: "Show both session ID and request ID to demonstrate per-request tracking",
  execute: async (_args, context) => {
